...
describe "Paymill Connect" do
  ...
  subject { get '/user/settings/connect', gateway: 'paymill' }
  ...
  it "save paymill connect to db" do
    VCR.use_cassette('paymill_connect_complete') do
     action = get '/user/settings/connect_callback', gateway: 'paymill',
