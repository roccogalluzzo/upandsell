IntercomRails.config do |config|
  # == Intercom app_id
  #
  config.app_id = ENV["INTERCOM_APP_ID"] || "7bv9ugi1"

  # == Intercom secret key
  # This is required to enable secure mode, you can find it on your Intercom
  # "security" configuration page.
  #
  config.api_secret = "dOfyVUiQEkAq93cdqRynHgv55t8wsAmzkYaqELa9"
  ...
  #
  config.api_key = "99b40c0d81ab18931b66ac6f9ca01b9b3a508087"
